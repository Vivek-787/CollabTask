...
orgTodoRouter.post("/add", auth, async (req, res) => {
    try {
        ...
        return res.json({ message: "To-Do Added Successfully", orgId: newOrgTodo._id});
    } catch (error) {
...
orgTodoRouter.put("/update/:id", auth, async (req, res) => {
    ...
    return res.json({ message: "To-Do updated Successfully", updateTodo });
    } catch (error) {
    console.log(error.message);
    return res.send(error.message);
  }
...
orgTodoRouter.put("/markDone/:id", auth, async (req, res) => {
    try{
        ...
        return res.json({ message: "To-Do marked complete Successfully", updatedTodo });
        } catch (error) {
        console.log(error.message);
        return res.send(error.message);
      }
